...
> **Внимание!** Статья написана с расчетом на G++-совмастимые компиляторы. Пользователи Visual Studio могут некоторые вещи отсюда узнать, но на практике применить их скорее всего не смогут.
...
Оффтоп от 2021 года: Intel начал сдавать позиции, AMD постепенно вытесняет его с рынка, но информация останется для истории

![](img/Intel-mmx-sse-sse2-avx-AVX-512.png)
...
![](img/indexed_gather_scatter3.png)
...
Нам, спортивным программистам, не очень интересна разреженная линейная алгебра, поэтому рассмотрим другой поучительный пример работы с несплошной памятью: оптимизацию [дерева Фенвика](fenwick.html). На этот раз интринзики писать не будем и целиком положимся на автовекторизацию.
